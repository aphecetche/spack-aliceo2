...
class AppleOpengl(Package):
    ...
    # FIXME : should probably get the version number(s) from
    # the tbd file of the OpenGL framework instead of hard coding it here
    version('4.0.0') 

    provides('gl',when=sys.platform=='darwin')
