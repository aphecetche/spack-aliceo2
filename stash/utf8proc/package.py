...
class Utf8proc(MakefilePackage):
    """A clean C library for processing UTF-8 Unicode data:
    normalization, case-folding, graphemes, and more"""

    # note that, while utf8proc offers a CMakeLists, we use the Makefile instead
    # as the cmake build does not install, for instance, the pkgconfig part...
    ...
    def edit(self, spec, prefix):
        ...
        makefile.filter('prefix=/usr/local',  'prefix={}'.format(self.prefix))
