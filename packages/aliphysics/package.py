...
class Aliphysics(CMakePackage):
    ...
    version('vAN-20211130', sha256='3834cbe8295fc8d8c7161aa6459f79fb1eac6486271a5245adc45340c446455d')
    ...
    depends_on('aliroot')
    depends_on('treelite')
    depends_on('vmc') # should not be necessary if aliroot used proper CMake targets...
