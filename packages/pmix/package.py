...
class Pmix(AutotoolsPackage):
    ...
    version('4.0.0', sha256='feb931660ea372e80dbd2751d76cb4a10ea42c33035c01c3b753900946efe69f')
    ...
    def patch(self):
        filter_file(r'PMIX\_INTERNAL\_ERR\_BASE','-1330','include/pmix_common.h.in')
